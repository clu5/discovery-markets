...
from .. import fieldnetwork


class Neo4jExporter(object):
    def __init__(self, host="localhost", port=7687, user="neo4j", pwd="aurum"):
    ...
    def export(self, path_to_model):
        ...
        for relation_label in Relation:
            ...
            relation_hits = field_network.enumerate_relation(
                relation_label, as_str=False
            )
            for a, b in tqdm(
                relation_hits,
