...
class Oracle:
    ...
    def analyze_causal_inference(self, source_table, source_col):
        ...
        for target in source_table.columns:
            ...
            p_forward, p_backward = self.causal_inference(
                to_analyze[source], to_analyze[target]
            )
...
if __name__ == "__main__":
    ...
    orig_metric = oracle.analyze_causal_inference(
        base_df, "SAT Critical Reading Avg. Score"
    )
